...
public class SortAdapter extends BaseAdapter implements SectionIndexer{
	private List<CarBrandEntity> list = null;
	private Context mContext;
	
	public SortAdapter(Context mContext, List<CarBrandEntity> list) {
	 ...
	 * @param list
	 */
	public void updateListView(List<CarBrandEntity> list){
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		final CarBrandEntity mContent = list.get(position);
		if (view == null) {
