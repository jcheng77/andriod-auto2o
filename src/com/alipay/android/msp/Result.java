...
public class Result {
	...
	static {
		...
		sResultStatus.put("9000", "�?作�?功");
		sResultStatus.put("4000", "系统异常");
		sResultStatus.put("4001", "数�?�格�?�?正确");
		sResultStatus.put("4003", "该用户绑定的支付�?账户被冻结或�?�?许支付");
		sResultStatus.put("4004", "该用户已解除绑定");
		sResultStatus.put("4005", "绑定失败或没有绑定");
		sResultStatus.put("4006", "订�?�支付失败");
		sResultStatus.put("4010", "�?新绑定账户");
		sResultStatus.put("6000", "支付�?务正在进行�?�级�?作");
		sResultStatus.put("6001", "用户中途�?�消支付�?作");
