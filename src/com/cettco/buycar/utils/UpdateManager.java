...
public class UpdateManager {
	...
	public UpdateManager(Context context,int isAutoCheck) {
		this.mContext = context;
	...
	public void checkUpdate() {
		/*
		 * if (isUpdate()) { // 显示提示对话框 showNoticeDialog(); //UpdateService
		 * service = new UpdateService(); } else { Toast.makeText(mContext,
		 * R.string.soft_update_no, Toast.LENGTH_LONG).show(); }
		 */
		isUpdate();
	}
	...
	private void showNoticeDialog() {
		...
		// View promptsView = li.inflate(R.layout.popup_update, null);
		...
		ImageView closeImageView = (ImageView) dialog
				.findViewById(R.id.popup_update_close_imageview);
		Button updateBtn = (Button) dialog
				.findViewById(R.id.popup_update_update_btn);
		updateBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				editor.putString("time", date_now);
				editor.commit();
				dialog.dismiss();
				Intent intent = new Intent();
				intent.setClass(UpdateManager.this.mContext,
						UpdateService.class);
		...
		// noticeDialog.getWindow().setBackgroundDrawable(new
		// ColorDrawable(R.color.white));
		// noticeDialog.show();
	}
